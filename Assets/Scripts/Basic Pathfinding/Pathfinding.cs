...
public class Pathfinding : MonoBehaviour
{
    ...
    void ExpandBreadthFirstSearchOpenList(Node node, int heuristicindex)
        {
            if (node != null)
            {
    ...
    void ExpandDepthFirstSearchOpenList(Node node, int heuristicindex)
    {
        if (node != null)
        {
